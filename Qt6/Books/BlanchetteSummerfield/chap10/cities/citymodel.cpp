...
{
    // По умолчанию возвращает Qt::ItemIsSelectable | At::ItemIsEnable
...
int CityModel::offsetOf(int row, int column)
{
    if (row < column)
        qSwap(row, column);
