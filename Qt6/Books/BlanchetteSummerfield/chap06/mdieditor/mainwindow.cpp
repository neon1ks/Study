...
void MainWindow::updateActions()
{
    ...
    bool hasSelection =
            activeEditor() && activeEditor()->textCursor().hasSelection();
...
void MainWindow::createActions()
{
    ...
    connect(cascadeAction, SIGNAL(triggered()), mdiArea,
    ...
    connect(nextAction, SIGNAL(triggered()), mdiArea,
...
{
    connect(editor, SIGNAL(copyAvailable(bool)), cutAction,
            SLOT(setEnabled(bool)));
    connect(editor, SIGNAL(copyAvailable(bool)), copyAction,
            SLOT(setEnabled(bool)));
