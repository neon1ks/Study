...
void MailClient::addFolder(const QIcon &icon, const QString &name)
{
    ...
    auto *newItem = new QTreeWidgetItem(root);
...
void MailClient::addMessage(
        const QString &subject, const QString &from, const QString &date)
{
    auto *newItem = new QTreeWidgetItem(messagesTreeWidget);
